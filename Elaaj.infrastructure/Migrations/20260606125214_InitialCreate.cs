        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmationCodeExpires = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PharmacyAdmins", x => new { x.UserId, x.PharmacyId });
                    table.ForeignKey(
                        name: "FK_PharmacyAdmins_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderPharmacyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReceiverPharmacyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PharmacyMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PharmacyMessages_Pharmacies_ReceiverPharmacyId",
                        column: x => x.ReceiverPharmacyId,
                        principalTable: "Pharmacies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PharmacyMessages_Pharmacies_SenderPharmacyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavorites_Pharmacies_PharmacyId",
                        column: x => x.PharmacyId,
                        principalTable: "Pharmacies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PostReplies_Pharmacies_PharmacyId",
                        column: x => x.PharmacyId,
                        principalTable: "Pharmacies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PharmacyMessages_ReceiverPharmacyId",
                table: "PharmacyMessages",
                column: "ReceiverPharmacyId");

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyMessages_SenderPharmacyId",
                table: "PharmacyMessages",
                column: "SenderPharmacyId");

            migrationBuilder.CreateIndex(
                name: "IX_PostReplies_PharmacyId",
                table: "PostReplies",
                column: "PharmacyId");
